"""
Django settings for photography_untouched project.
...
ROOT_URLCONF = 'photography_untouched.urls'
...
WSGI_APPLICATION = 'photography_untouched.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(PROJECT_ROOT, 'photography_untouched', 'static', 'photos'),
)
